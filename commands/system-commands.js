...
const serifItalic  = make(0x1D434, 0x1D44E, null, { h: 'ℎ' });
...
// Menu ke fonts (.setfont) — menu-settings.js yahan se leta hai
module.exports.FONTS = {
    bolditalic: serifBI, bold: serifBold, italic: serifItalic, script: scriptBold, fraktur: frakturBold,
    mono, sans: sansPlain, sansbold: sansBold, double: doubleStruck, smallcaps: smallCaps, plain: (x) => x
};